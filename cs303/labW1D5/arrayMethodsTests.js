...
// const scopySorted = myExports.copySorted;
...
describe("copySorted", function () {
    ...
    it("returns the sortedArray", function () {
...
describe("getAverageAge", function () {
    it("returns the avg age", function () {
        let john = { name: "John", age: 25 };
        let pete = { name: "Pete", age: 30 };
    ...
    it("return the avg age once more", function () {
        let john = { name: "John", age: 50 };
        let pete = { name: "Pete", age: 30 };
        let mary = { name: "Mary", age: 40 };
        let arr = [john, pete, mary];

        assert.deepEqual(getAverageAge(arr), 40);
    });
});
