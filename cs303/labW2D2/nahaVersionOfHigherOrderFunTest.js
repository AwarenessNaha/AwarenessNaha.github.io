...
const myExports = require("./nahaVersionOfHigherOrderfun.js");  //with node need the name of your file with your functions here
...
describe("my own array. reduce()", function () {
    it("return a new array RRAA", function () {
        let arr = [5, 3, 8, 1];
        let prev = 0;
        let reduced = myOwnReduce(arr, (prev, item) => {
            let sum = prev;
            return item + sum
        });
        assert.strictEqual(reduceed, 17);
    });
